...
class ResetDemoSite extends Command
{
    ...
    private function seedAdminLinks(User $admin)
    {
        ...
        $admin->linkOverlays()->create([
            ...
            'colors' => json_decode('{"bg-color":"#3e4a66","text-color":"rgba(255, 255, 255, 1)","label-bg-color":"rgb(255, 255, 255)","label-color":"rgba(0, 0, 0, 0.87)","btn-bg-color":"#4662FA","btn-text-color":"rgba(255, 255, 255, 1)"}', true),
        ]);
